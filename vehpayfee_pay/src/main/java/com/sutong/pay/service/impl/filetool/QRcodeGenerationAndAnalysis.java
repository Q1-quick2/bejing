...
@Component
public class QRcodeGenerationAndAnalysis {
    //二维码图片编码格式
    ...
    public int getQRCODE_SIZE() {return QRCODE_SIZE; }
    ...
    public void encode(String content, String imgPath, HttpServletResponse response, boolean needCompress) throws Exception {
        BufferedImage image = createImage(content, imgPath, needCompress);
        // String file = new Random().nextInt(99999999)+".jpg";
        // ImageIO.write(image, FORMAT_NAME, new File(destPath+"/"+file));
