...
@Data
@ToString
public class AppAuditPastOrderModel implements Serializable {
    ...
    private  String transAllMoney;      //交易总金额
    private  String orderOweFee;        //应缴总金额
    /* *通行费差额明细单* */
    ...
    private BigDecimal endActpayamt;//单位：分,实际支付金额
